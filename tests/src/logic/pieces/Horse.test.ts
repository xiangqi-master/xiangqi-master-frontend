...
describe("Horse in an empty board", () => {
  ...
  test("red horse at (1, 0)", () => {
    ...
    const actualMoves: Position[] = horse.getAllValidMoves(board)
...
describe("Horse surrounded by obstacles", () => {
  ...
  test("red horse at (2, 2) surrounded by 1 red pawn", () => {
    ...
    const board = emptyBoard.addPiece(new PawnStub(true, new Position(2, 3)))
    const expectedValidMoves: Position[] = [
      new Position(1, 0),
      new Position(3, 0),
      new Position(0, 1),
  ...
  test("red horse at (2, 2) surrounded by 1 black pawn", () => {
    const horse = createHorse(true, new Position(2, 2))
    const board = emptyBoard.addPiece(new PawnStub(false, new Position(2, 3)))
    const expectedValidMoves: Position[] = [
      new Position(1, 0),
      new Position(3, 0),
      new Position(0, 1),
  ...
  test("red horse at (4, 6) surrounded by 2 black pawns", () => {
    ...
    const board = emptyBoard
      .addPiece(new PawnStub(false, new Position(4, 5)))
      .addPiece(new PawnStub(false, new Position(3, 6)))
    const expectedValidMoves: Position[] = [
      new Position(3, 8),
      new Position(5, 8),
      new Position(5, 8),
  ...
  test("red horse at (2, 5) surrounded by 3 red pawns", () => {
    ...
    const board = emptyBoard
      .addPiece(new PawnStub(true, new Position(1, 5)))
      .addPiece(new PawnStub(true, new Position(2, 6)))
  ...
  test("red horse's path at (2, 5) blocked by 6 red pawns", () => {
    const horse = createHorse(true, new Position(2, 5))
    const board = emptyBoard
      .addPiece(new PawnStub(true, new Position(1, 7)))
      .addPiece(new PawnStub(true, new Position(3, 7)))
      .addPiece(new PawnStub(true, new Position(0, 6)))
      .addPiece(new PawnStub(true, new Position(4, 6)))
      .addPiece(new PawnStub(true, new Position(0, 4)))
      .addPiece(new PawnStub(true, new Position(4, 4)))
  ...
  test("red horse's path at (2, 5) blocked by 8 black pawns", () => {
    const horse = createHorse(true, new Position(2, 5))
    const board = emptyBoard
      .addPiece(new PawnStub(false, new Position(1, 7)))
      .addPiece(new PawnStub(false, new Position(3, 7)))
      .addPiece(new PawnStub(false, new Position(0, 6)))
      .addPiece(new PawnStub(false, new Position(4, 6)))
      .addPiece(new PawnStub(false, new Position(0, 4)))
      .addPiece(new PawnStub(false, new Position(4, 4)))
      .addPiece(new PawnStub(false, new Position(1, 3)))
